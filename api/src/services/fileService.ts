...
// When running from api/ directory, process.cwd() = /path/to/api
// So data directory should be at process.cwd()/data
// This works in both development (tsx) and production (compiled)
